...
export const AccountActivationEmail = async (email, data) => {
  ...
  await transport.sendMail({
    from: "Authontication project <sekhmontajulali1997@gmail.com>",
    subject: "Activate",
    to: email,
    html: `
...
<div align="center" class="alignment" style="line-height:10px"><img alt="I'm an image" src="https://static.vecteezy.com/system/resources/previews/022/488/748/non_2x/3d-render-meta-chat-messenger-facebook-messenger-icon-bubble-isolated-on-transparent-background-free-png.png" style="display: block; height: auto; border: 0; max-width: 120px; width: 100%;" title="I'm an image" width="120"/></div>
</td>
</tr>
</table>
